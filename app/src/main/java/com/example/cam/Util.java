...
public class Util {
    ...
    private static BasicAWSCredentials sBasicAWSCredentials;
    
    private static BasicAWSCredentials getBasicAWSCredentials(Context context) {
        if (sBasicAWSCredentials == null) {
        	sBasicAWSCredentials = new BasicAWSCredentials(Constants.AWS_ACCESS_KEY, Constants.AWS_SECRET_KEY);
        }
        return sBasicAWSCredentials;
    }
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            sS3Client = new AmazonS3Client(getBasicAWSCredentials(context.getApplicationContext()));
        }
        return sS3Client;
    }
